...
const aboutContent = (
  <div className="space-y-6">
    <p>
      ...
      Normalize whitespace, indentation, and line endings for clean, consistent text.
    </p>
    ...
    <div className="space-y-4">
      <div>
        ...
        <ul className="list-disc pl-6 space-y-2">
          <li><strong>Remove Extra Whitespace:</strong> Collapse multiple spaces into single spaces</li>
          <li><strong>Normalize Punctuation:</strong> Fix spacing around punctuation marks</li>
          <li><strong>Convert Tabs:</strong> Transform tabs to spaces or vice versa</li>
          <li><strong>Line Endings:</strong> Standardize line endings (CRLF/LF)</li>
          <li><strong>Trim Lines:</strong> Remove leading/trailing whitespace from each line</li>
          <li><strong>Empty Lines:</strong> Remove or normalize empty lines</li>
        </ul>
      </div>
    ...
    <div className="space-y-4">
      <div>
        ...
        <ul className="list-disc pl-6 space-y-2">
          <li>Use "Remove Extra Whitespace" for general text cleanup</li>
          <li>Enable "Normalize Punctuation" for professional documents</li>
...
export function FixSpacingTool() {
  ...
  const processText = React.useCallback((text: string, options: SpacingOptions) => {
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="flex items-center space-x-2">
                    <Switch
                      ...
                      onCheckedChange={() => handleOptionChange('removeExtraWhitespace')}
                    />
                    <Label htmlFor="extra-whitespace">Remove Extra Whitespace</Label>
                  </div>
                  <div className="flex items-center space-x-2">
                    <Switch
                      id="normalize-punctuation"
                      checked={spacingOptions.normalizePunctuation}
                      onCheckedChange={() => handleOptionChange('normalizePunctuation')}
                    />
                    <Label htmlFor="normalize-punctuation">Normalize Punctuation</Label>
                  </div>
                  <div className="flex items-center space-x-2">
                    <Switch
                      id="convert-tabs"
                      checked={spacingOptions.convertTabsToSpaces}
                      onCheckedChange={() => handleOptionChange('convertTabsToSpaces')}
                    />
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    />
                    <Label htmlFor="normalize-endings">Normalize Line Endings</Label>
                  </div>
                  <div className="flex items-center space-x-2">
                    <Switch
                      id="trim-lines"
