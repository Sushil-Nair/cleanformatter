...
const aboutContent = (
  <div className="space-y-6">
    <p>
      Generate random text with our <strong>Text Generator Tool</strong>. 
      Create Lorem Ipsum, random words, or sentences in multiple languages.
    </p>
    ...
    <div className="space-y-4">
      <div>
        ...
        <ul className="list-disc pl-6 space-y-2">
          <li><strong>Lorem Ipsum:</strong> Classic placeholder text</li>
          <li><strong>Random Words:</strong> Generate word sequences</li>
          <li><strong>Random Sentences:</strong> Create coherent sentences</li>
          <li><strong>Multiple Languages:</strong> English, Spanish, Arabic</li>
        </ul>
      </div>
      ...
      <div>
        ...
        <ul className="list-disc pl-6 space-y-2">
          <li><strong>Word Count Control:</strong> Specify total number of words</li>
          <li><strong>Format Options:</strong> Plain text or HTML</li>
          <li><strong>Real-time Preview:</strong> See changes instantly</li>
          <li><strong>Copy & Download:</strong> Export generated text</li>
        </ul>
      </div>
    </div>
              ...
              <div className="space-y-4">
                <div className="grid grid-cols-2 gap-4">
                  ...
                  >
                    ...
                    <SelectContent>
                      ...
                      <SelectItem value="sentences">Random Sentences</SelectItem>
                    </SelectContent>
                  </Select>
                ...
                <div className="space-y-2">
                  ...
                  <Slider
                    ...
                    step={10}
                    onValueChange={([value]) => 
                      setOptions(prev => ({ ...prev, wordsPerParagraph: value }))
                    }
                  />
                </div>
                ...
                <div className="flex items-center space-x-2">
                  <Switch
                    ...
                    onCheckedChange={(checked) => 
                      setOptions(prev => ({ ...prev, format: checked ? 'html' : 'plain' }))
                    }
                  />
