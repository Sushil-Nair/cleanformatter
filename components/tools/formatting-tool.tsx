...
const aboutContent = (
  <div className="space-y-6">
    <p>
      Clean and format your text with our powerful <strong>Remove Formatting Tool</strong>. 
      Strip away unwanted formatting while preserving the content you need.
    </p>
    ...
    <div className="space-y-4">
      <div>
        ...
        <ul className="list-disc pl-6 space-y-2">
          <li><strong>Strip HTML:</strong> Remove HTML tags while keeping content</li>
          <li><strong>Remove Markdown:</strong> Clean Markdown syntax</li>
          <li><strong>Plain Text:</strong> Convert to clean, readable text</li>
          <li><strong>Remove Styles:</strong> Strip inline formatting</li>
          <li><strong>Clean Links:</strong> Remove hyperlinks, keep text</li>
          <li><strong>Fix Spacing:</strong> Normalize whitespace and indentation</li>
        </ul>
      </div>
...
export function FormattingTool() {
  ...
  const processText = React.useCallback((text: string, options: FormatOptions) => {
  ...
  return (
    <div className="container max-w-6xl mx-auto px-4 py-8">
      <div className="space-y-4">
        <div>
          <h1 className="text-3xl font-bold tracking-tight">Remove Formatting</h1>
