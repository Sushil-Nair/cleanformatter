...
const aboutContent = (
  <div className="space-y-6">
    <p>
      ...
      Get detailed information about any character including its properties, encoding, and script details.
    </p>
    ...
    <div className="space-y-4">
      <div>
        ...
        <ul className="list-disc pl-6 space-y-2">
          <li><strong>Unicode Properties:</strong> Code point, name, category</li>
          <li><strong>Script Details:</strong> Writing system, direction</li>
          <li><strong>Encoding:</strong> UTF-8, UTF-16, UTF-32 representations</li>
          <li><strong>Special Properties:</strong> Emoji, math, symbols</li>
        </ul>
      </div>
      ...
      <div>
        ...
        <ul className="list-disc pl-6 space-y-2">
          <li><strong>Search:</strong> Find characters by name or code point</li>
          <li><strong>Copy:</strong> One-click character copying</li>
          <li><strong>Details:</strong> Comprehensive character analysis</li>
        </ul>
      </div>
    </div>
...
export function CharacterFinderTool() {
  ...
  const [selectedChar, setSelectedChar] = React.useState<CharacterDetails | null>(null)
  ...
  const handleSearch = () => {
    ...
    try {
      ...
      if (searchQuery.startsWith('U+') || searchQuery.startsWith('u+')) {
        ...
        toast({
          title: "Invalid Input",
          description: "Please enter a single character or Unicode code point (U+XXXX)",
          variant: "destructive",
        })
        return
      }
  ...
  return (
    <div className="container max-w-6xl mx-auto px-4 py-8">
      <div className="space-y-4">
        <div>
          <h1 className="text-3xl font-bold tracking-tight">Character Finder</h1>
                ...
                <div className="space-y-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <Table>
                      ...
                      <TableBody>
                        <TableRow>
                          <TableCell className="font-medium">Code Point</TableCell>
                          <TableCell>U+{selectedChar.info.codePoint.toString(16).toUpperCase().padStart(4, '0')}</TableCell>
                        </TableRow>
                        <TableRow>
                          <TableCell className="font-medium">Name</TableCell>
                          <TableCell>{selectedChar.info.name || 'Unknown'}</TableCell>
                        </TableRow>
                        <TableRow>
                        ...
                        <TableRow>
                          <TableCell className="font-medium">Bidirectional</TableCell>
                    ...
                    <Table>
                      ...
                      <TableBody>
                        <TableRow>
                          ...
                          <TableCell>{selectedChar.encoding.utf8.map(b => b.toString(16).toUpperCase().padStart(2, '0')).join(' ')}</TableCell>
                        </TableRow>
                        <TableRow>
                          <TableCell className="font-medium">UTF-16</TableCell>
                          <TableCell>{selectedChar.encoding.utf16.map(b => b.toString(16).toUpperCase().padStart(4, '0')).join(' ')}</TableCell>
                        </TableRow>
                        <TableRow>
                          <TableCell className="font-medium">UTF-32</TableCell>
                          <TableCell>{selectedChar.encoding.utf32.map(b => b.toString(16).toUpperCase().padStart(8, '0')).join(' ')}</TableCell>
                        </TableRow>
                        <TableRow>
                          ...
                          <TableCell>
                            {[
                              ...
                              selectedChar.encoding.isNonCharacter && 'Non-Character',
                              selectedChar.encoding.isPrivateUse && 'Private Use'
                            ].filter(Boolean).join(', ') || 'None'}
                          </TableCell>
                        </TableRow>
                      </TableBody>
