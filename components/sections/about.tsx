...
export function AboutSection() {
  return (
    <section id="about" className="py-16 md:py-24 scroll-mt-16 mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-center">
          <div className="space-y-6">
            ...
            <p className="text-muted-foreground md:text-lg">
              Clean Formatter was created to solve a common problem: the need to
              quickly transform text between different case formats without
            ...
            <div className="space-y-4">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">
                    Our minimal interface lets you focus on your content, not
                    the tool.
                  </p>
                </div>
              </div>
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">
                    As a Progressive Web App, Case Converter works even without
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">
                    Use on desktop, tablet, or mobile with a consistent
